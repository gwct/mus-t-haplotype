...
infile = here("data", paste0("mm10-", window_size, "kb-topo-counts-new-tree-no-pahari.csv"))
...
aln_stats_file = here("data", paste0("mm10-", window_size, "kb-window-stats-new-tree-no-pahari.tsv"))
...
spec_counts_file = here("data", paste0("mm10-", window_size, "kb-spec-counts-new-tree-no-pahari.tsv"))
...
inv_bp_dists_file = here("data", "coord-query-new-tree-no-pahari", "inv-bps-5-Mb.bed.chr17.dists")
...
rand_dists_file = here("data", "coord-query-new-tree-no-pahari", "inv-bps-5-Mb.bed.chr17.random")
...
inv_bp_windows = all_windows_f_overlaps %>% 
  ...
  arrange(start)
tree1 = plotBPTree(inv_bp_windows[1,], 0.16)
tree2 = plotBPTree(inv_bp_windows[2,], 0.06)
# Get the trees around both breakpoints
...
inv_bp_windows = all_windows_f_overlaps %>% 
  ...
  arrange(start)
tree1 = plotBPTree(inv_bp_windows[1,], 0.35)
