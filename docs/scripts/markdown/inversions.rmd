...
col_rank = 1
for(i in unique(topo_counts$topo.rank.overall)){
  print(i)
  row = subset(topo_counts, topo.rank.overall==i)
  ...
  topo_counts$col.cat[topo_counts$topo.rank.overall==i] = new_label

  if(row$topo.rank.overall > max_tree_rank){
    topo_counts$topo.color[topo_counts$topo.rank.overall==i] = "#333333"
  }
...
doStats <- function(df, yvar, ylabel, filter_flag = FALSE){
  ...
  df_anova_res_sample = sample(df_anova_res, 5000)
